import { useDeleteAdminMutation } from "@/api/endpoints/getadmin.api";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function DeleteAdminBtn({ id }: { id: string }) {
  const [isOpen, setIsOpen] = useState(false);
  const [deleteBlog, { isLoading }] = useDeleteAdminMutation();
